...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    CallNumber: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 12;
      }>;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CTA: Schema.Attribute.Component<'layout.cta-section', true>;
    Footer: Schema.Attribute.Component<'layout.footer', false>;
    Header: Schema.Attribute.Component<'layout.header', false>;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Services: Schema.Attribute.Component<'layout.services', false>;
    Story: Schema.Attribute.Component<'layout.our-story', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Workcard: Schema.Attribute.Component<'components.workcard', true>;
